...
//   fillPriceChart() {
//     Meteor.defer(() => {
//       if (Session.get('rendered') && typeof mintcharts.price === 'undefined') {
//         const ctx = document.getElementById('market-chart-price');
//         mintcharts.price = new Chart(ctx, {
//           type: 'line',
//           data: {},
//           options: {
...
//       });
//       mintcharts.price.data.labels = trades.map(trade => trade.timestamp);
//       mintcharts.price.data.datasets = [{
//         data: prices,
//         borderColor: '#03A9F4',
//         borderWidth: 3,
...
//       mintcharts.price.update();
//     }
//   },
//   fillDepthChart() {
//     Meteor.defer(() => {
//       if (Session.get('rendered') && typeof mintcharts.depth === 'undefined') {
//         const ctx = document.getElementById('market-chart-depth');
//         mintcharts.depth = new Chart(ctx, {
//           type: 'line',
//           data: {},
//           options: {
//             layout: {
...
//       mintcharts.depth.data.labels = vals;
//       mintcharts.depth.data.datasets = [
//         {
//           label: 'Buy',
...
//           steppedLine: true,
//         }];
//         mintcharts.depth.update();
//     }
//   },
//   fillVolumeChart() {
//     Meteor.defer(() => {
//       if (Session.get('rendered') && typeof mintcharts.volume === 'undefined') {
//         const ctx = document.getElementById('market-chart-volume');
//         mintcharts.volume = new Chart(ctx, {
//           type: 'line',
//           data: {},
//           options: {
//             layout: {
...
//       mintcharts.volume.data.labels = days;

//       mintcharts.volume.data.datasets = [{
//         label: 'Volume',
...
//       mintcharts.volume.update();
//     }
//   },
// });

Template.mintchart.onRendered(() => {
